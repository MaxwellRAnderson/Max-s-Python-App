...
def open_maxwell_account():
    ...
    tk.Button(maxwell_window, text="Run Script", command=open_run_script).pack(pady=10)
...
def open_rcsd_account():
    ...
    tk.Button(rcsd_window, text="Run Script", command=open_run_script).pack(pady=10)
...
def open_run_script():
    ...
    if file_path:
        try:
            ...
            messagebox.showinfo("Run Script", f"Executed the script from {file_path}")
